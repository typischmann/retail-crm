...
values(200000001, 10000001, 10003, 4, 1);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000002, 10000002, 10005, 14, 2);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000003, 10000003, 10005, 160, 3);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000004, 10000003, 10002, 156, 4);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000005, 10000004, 10005, 11, 5);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000006, 10000005, 10005, 1, 6);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000007, 10000006, 10005, 38, 7);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000008, 10000006, 10002, 2, 8);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000009, 10000006, 10005, 7, 9);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000010, 10000008, 10005, 1, 10);

insert into ORDER_ITEMS (ID, ORDER_ID, PRODUCT_ID, AMOUNT, PRICE_ID)
values(200000011, 10000009, 10003, 28, 11);
